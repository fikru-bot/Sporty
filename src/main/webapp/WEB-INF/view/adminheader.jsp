				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarNav">
						...
						<ul class="navbar-nav">
							...
							<li class="nav-item"><a class="nav-link" href="category">Add
									Catagory</a></li>
							<li class="nav-item"><a class="nav-link"
								href="category/search">Catagory List</a></li>
							<li class="nav-item"><a class="nav-link" href="prod">Add
									Product</a></li>
							<li class="nav-item"><a class="nav-link" href="prod/search">Product
									List</a></li>
							<li class="nav-item"><a class="nav-link"
								href="bookProd/search">Purchased List</a></li>
